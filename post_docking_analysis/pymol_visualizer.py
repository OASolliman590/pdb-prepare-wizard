...
and interaction analysis using PyMOL with configuration support.
"""
import pandas as pd
import numpy as np
...
class PyMOLVisualizer:
    ...
    def create_best_poses_gallery(self, pdb_files: List[Path], 
        ...
        # Limit to first 10 poses for performance and clarity
...
def create_comparative_analysis(reference_pdb: Path, novel_pdb: Path,
                              output_dir: Path, highlight_residues: List[int] = None,
    ...
    visualizer = PyMOLVisualizer(output_dir, config)
